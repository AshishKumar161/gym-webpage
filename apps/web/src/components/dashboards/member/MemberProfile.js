...
export async function renderMemberProfile() {
  ...
  return `
    <h2 class="dash-header-title">My Profile</h2>
    <p class="dash-subtitle">Update your personal details, password, and fitness goals.</p>

    <div style="display:grid; grid-template-columns: repeat(auto-fit, minmax(350px, 1fr)); gap:2rem; margin-top:2rem;">
      <!-- Profile Details Form -->
      <div class="glass-card" style="padding:2rem;">
        <h3 style="margin-bottom:1.5rem; font-family:var(--font-display);">👤 Personal Information</h3>
      ...
      <div class="glass-card" style="padding:2rem;">
        <h3 style="margin-bottom:1.5rem; font-family:var(--font-display);">🔒 Security</h3>
